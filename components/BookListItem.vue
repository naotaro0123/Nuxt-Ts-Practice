<template lang="pug">
b-card.mb-2.card(:title="title", :img-src="thumbnail", img-alt="Image", img-top="",
  ...
  get description() {
    try {
      if (
        ...
        this.book.volumeInfo!.description.length > 30
      ) {
        return (
          this.book.volumeInfo!.description.substr(0, 30) + '(...続きを読む)'
        );
      }
